      ...
      {Object.keys(initialValues).length > 0 ? (
        <Formik
          ...
          validate={(values) => {
            ...
            if (!values.expiresAt) {
              errors.expiresAt = 'La fecha de expiración es obligatoria.';
            }
            return errors;
          }}
          ...
          {({ isSubmitting }) => (
            <Form className="modify-product__form">
              <div className="modify-product__field">
                <label htmlFor="name" className="modify-product__label">Nombre del producto</label>
                <Field type="text" name="name" id="name" className="modify-product__input" />
                <ErrorMessage name="name" component="div" className="modify-product__error" />
              </div>

              <div className="modify-product__field">
                <label htmlFor="description" className="modify-product__label">Descripción</label>
                <Field as="textarea" name="description" id="description" className="modify-product__input" />
                <ErrorMessage name="description" component="div" className="modify-product__error" />
              </div>

              <div className="modify-product__field">
                <label htmlFor="price" className="modify-product__label">Precio</label>
                <Field type="number" name="price" id="price" className="modify-product__input" step="0.01" />
                <ErrorMessage name="price" component="div" className="modify-product__error" />
              </div>

              <div className="modify-product__field">
                <label htmlFor="stock" className="modify-product__label">Cantidad</label>
              ...
              <div className="modify-product__field">
                ...
                <Field as="select" name="category" id="category" className="modify-product__input">
  ...
  <label>
    ...
    No Publicable
              ...
              <div className="modify-product__field">
                ...
                <Field type="date" name="expiresAt" id="expiresAt" className="modify-product__input" />
                <ErrorMessage name="expiresAt" component="div" className="modify-product__error" />
              </div>

              {imageUrl && (
                <div className="modify-product__field">
                  <label className="modify-product__label">Imagen Actual</label>
                  <img src={imageUrl} alt="Imagen actual del producto" className="modify-product__image" />
                </div>
              )}

              <div className="modify-product__field">
                <label htmlFor="file" className="modify-product__label">Subir Nueva Imagen</label>
                <input type="file" id="file" className="modify-product__input" onChange={handleFileChange} />
              </div>

              <button type="submit" className="modify-product__button" disabled={isSubmitting}>
